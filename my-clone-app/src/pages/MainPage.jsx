...
const MainPage= () => {
    ...
    // 처음 렌더링되었을 때 샘플데이터를 contents에 저장

    useEffect(function() {
        const sample = [{img: 'https://occ-0-3673-993.1.nflxso.net/dnm/api/v6/mAcAr9TxZIVbINe88xb3Teg5_OA/AAAABfcMlsuUukeGbyG2qygmBOj4sOAy2pojdTNj48Np2p2HkU23q5qlnQpAiASKlu9un1VmGrcxApLNG1Q8zdFoTWDOnrXJSYKjiQXycxy99iP5oYpJj4E300K8cOsN0cN1uhMxdyj4_BRos7soKZnyClxn9k8EsoNd4KjSjA2G5jGdx12VELeTC3HOhmUgi1mO4FHclC9YpxNJS-e80gL3238-m0NOsATjJVsq5iMZ58nUS75Ldv6xe8G3q92mYGRZK_O5fFrH8SthVvdNK6IdWEnocnNpV7sOkB2-20aK2o_5hsgi_mdoeQ_rVCHEhjxaEAIVI4HiQHUXiLDbHFhlKY0_odWyAwZyKaqqW-b80rYSSZ0HrA.webp?r=371', text: ''},
